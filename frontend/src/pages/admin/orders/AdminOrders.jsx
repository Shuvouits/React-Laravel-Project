                    ...
                    {orders.map((order) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <td className="max-w-[170px] px-[10px] py-[14px]">

                                    <p className="truncate text-[12px] font-medium text-[#445268]">
                                        {productSummary}
                                    </p>
                                ...
                                <td className="max-w-[190px] px-[10px] py-[14px]">
                                ...
                                <td className="px-[10px] py-[14px] text-center">
                                    ...
                                    <button
                                        ...
                                        className="inline-flex h-[34px] w-[34px] items-center justify-center rounded-[8px] border border-[#dddddd] bg-white text-[#333] transition hover:bg-[#f4f4f4] disabled:cursor-not-allowed disabled:opacity-50"
                                    >
                                        {actionBusy ? (
                                            <LoaderCircle
                                                size={16}
...
const OrderActionMenu = ({
    ...
    return (
        <div
            ...
            className="fixed z-[9999] w-[190px] overflow-hidden rounded-[12px] border border-[#e3e3e3] bg-white py-[6px] text-left shadow-[0_12px_35px_rgba(0,0,0,0.16)]"
        >
            ...
            <button
                ...
                className="flex w-full items-center gap-[10px] px-[14px] py-[10px] text-[13px] font-medium text-red-500 transition hover:bg-red-50"
            >
                <XCircle size={16} />
...
const DeliveryBadge = ({ status }) => {
    const normalized =
        String(status || "not_shipped")
            .toLowerCase();

    if (normalized === "delivered") {
        return (
            <span className="inline-flex whitespace-nowrap rounded-full bg-[#dff9ec] px-[10px] py-[5px] text-[11px] font-medium text-[#158457]">
                Delivered
            </span>
        );
    }
    ...
    if (normalized === "shipped") {
        return (
            <span className="inline-flex whitespace-nowrap rounded-full bg-[#e8f1ff] px-[10px] py-[5px] text-[11px] font-medium text-[#2467d5]">
                Shipped
            </span>
        );
    }
    ...
    return (
        <span className="inline-flex whitespace-nowrap rounded-full bg-[#f0f4f8] px-[10px] py-[5px] text-[11px] font-medium text-[#536273]">
            Not shipped
        </span>
    );
};
