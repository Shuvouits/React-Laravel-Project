    ...
    const fetchCustomers = async (search = "") => {
        try {
            ...
            const response = await api.get(
                "/vendor/orders/create/customers",
                {
                    params: {
                        search,
                    },
...
export default VendorOrderCreate;